      ...
      <Modal
        ...
        <View
          ...
          <FlatList
            ...
            ListHeaderComponent={
              <RowComponent
                stylesCustom={{alignItems: 'center', justifyContent: 'center'}}>
            ...
            renderItem={({item}) => (
              <RowComponent
                ...
                key={item.value}
                stylesCustom={{paddingVertical: 16}}>
                <TextComponent
                  size={16}
                  text={item.label}
                  color={
          ...
          />
          <ButtonComponent title="Confirm" onPress={handleConfirmSelect} />
        </View>
      </Modal>
    </View>
  );
